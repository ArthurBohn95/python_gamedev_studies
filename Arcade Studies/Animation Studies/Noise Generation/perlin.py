...
def smoothstep_imp(t):
    """Improved smooth step.
    """
...
#     imgs.append(img)
#     img.save("perlin/noiseframe{:03d}.png".format(t))
#     _e = perf_counter()
#     print(f"Frame {t:03}: {1000*(_e-_s):.0f}")

# imgs[0].save("test.gif", save_all=True, append_images=imgs[1:])